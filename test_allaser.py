...
# Put here IP and Port of a broker containg ALLaser
IP="127.0.0.1"
PORT=9559
...
#________________________________
def main():
    print '        START TESTING ALLaser MODULE'
    try:
        ALLaser_Proxy = ALProxy("ALLaser",IP,PORT)
    except Exception,e:
    ...
    try:
        ret = ALLaser_Proxy.DummyFunction( "hello, world", inParam )
    except Exception,e:
        print "ALLaser test Failed"
        return(1)
